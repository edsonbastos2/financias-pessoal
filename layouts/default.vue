            ...
            <div class="flex-1 flex items-center items-stretch justify-start">
              ...
              <div class="hidden sm:block sm:ml-6">
                <div class="flex space-x-4">
                  ...
                  <NuxtLink to="/categories" :class="{'bg-gray-900 text-white px-3 py-2 rounded-md text-sm font-medium': $route.name === 'categories',
                    'text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium': $route.name !== 'categories'}">Categorias</NuxtLink>
                  <!-- <a
                    href="#"
